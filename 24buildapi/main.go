...
func main() {
	...
	// seeding
	courses = append(courses, Course{CourseId: "2", CourseName: "react-js", CoursePrice: 299, Author: &Author{Fullname: "Pulkit", Website: "pulkit.com"}})
...
func createOneCourse(w http.ResponseWriter, r *http.Request) {
	...
	if IsEmpty(&course) {
		json.NewEncoder(w).Encode("No idea inside json")
		return
	}
